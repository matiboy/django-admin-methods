...
setup(
    ...
    url='https://github.com/matiboy/django-admin-methods.git',
    ...
    classifiers=[
        ...
        'Topic :: Software Development :: Django admin',
    ...
    packages=find_packages(exclude=['actions', 'list_fields', 'model_fields', 'docs', 'tests*']),
