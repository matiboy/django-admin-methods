...
| Parameter        | Default                             | Description                                                                                                                                                                                                                                 |
|------------------|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| field_name       |                                     | the model ImageField name, or the name of a method that returns an ImageField                                                                                                                                                               |
...
| template_path    | admin_methods/list/image_thumb.html | the path to a template loaded via Django's templating engine. Override to use own templates                                                                                                                                                 |
